...
export const list = (regexp) => [
          ...
          <li>
            <ul className="minimin-requirements-list">
              <li>
                <p>
                  <Highlighted
                    text="Recurring and verifiable source of income and minimun annual
                  income of $20,000"
                    regexp={regexp}
                  />
                </p>
  ...
  {
    title: <Highlighted text="How do I make my payments?" regexp={regexp} />,
  ...
  },
  {
    ...
    content: (
      <p>
        ...
        without cost or finance charges, no later than 3:00 p.m. Eastern time of
        the next business day immediately following the Disbursement Date. Your
        right to cancel your loan only applies if your loan either has not
        funded or, if it has, the funds are returned to us. To cancel your
        payment obligations on this loan, you must inform us in writing, by or
        before the Cancellation Deadline, by email to"
          regexp={regexp}
        />{" "}
        ...
        <Highlighted
          text=" that you want to cancel the future payment obligations on this loan. If
        we receive payment of the principal amount via the debit, then both your
        and our obligations under this Loan Agreement will be rescinded. If we
        do not receive payment of the principal amount by debit from Your Bank
  ...
  },
  {
    ...
    content: (
      <p>
        <Highlighted
          text=" Of course! We encourage paying your loan back early, which reduces the
        amount of finance charges. You can pay your outstanding balance at any
        time without a prepayment penalty — simply visit the"
          regexp={regexp}
        />{" "}
        <LoginButton className="link underline">My Account login</LoginButton>{" "}
        on our website or reach out to our Customer Care{" "}
        <Highlighted text="using the methods listed on our" regexp={regexp} />{" "}
  ...
  },
  {
    ...
    content: (
      <p>
        <Highlighted
          text="Amicus Lending is a wholly-owned and operated entity of the Mechoopda
        Indian Tribe of Chico Rancheria. The Company was established for the
        Tribe’s economic benefit and is organized under and operates pursuant to
        Tribal law. The Mechoopda Indian Tribe of Chico Rancheria is a federally
        recognized Indian tribe and a sovereign nation, as expressly recognized
        under federal law. See 75 Fed. Reg. 60,810, 60,811. To learn more about
        the Mechoopda Indian Tribe of Chico Rancheria, click"
          regexp={regexp}
        />{" "}
