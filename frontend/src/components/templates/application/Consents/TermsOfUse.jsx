    ...
    <Wrapper>
      <div id="terms-of-use" className="print-page">
        <ul className="list">
          <li>
            <p>
              <b>PLEASE READ THESE TERMS OF USE CAREFULLY</b>. Your access and
              use of any domains and websites (collectively, a <b>"Site"</b>),
              which are operated by Amicus Lending (<b>"Amicus Lending"</b> or{" "}
              <b>"Lender"</b>), and your access and use of any of the services
              that Amicus Lending provides or offers through a Site
              (collectively <b>"Services"</b>) are covered by and subject to
              these Terms of Use.
            </p>
          </li>
          <li>
            <p>
              <b>
                LENDER IS AN ARM OF THE MECHOOPDA INDIAN TRIBE OF CHICO
                RANCHERIA, A FEDERALLY RECOGNIZED INDIAN TRIBE AND SOVEREIGN
                NATION ("TRIBE"). IT IS AN ENTITY FORMED AND OPERATED PURSUANT
                TO TRIBAL LAW, IT IS OWNED AND OPERATED BY THE TRIBE, AND IT WAS
                ...
                FINANCE SERVICES REGULATORY AUTHORITY (THE "AUTHORITY") IN
          ...
          <li>
            ...
            <p>
              Amicus Lending reserves the right in its sole discretion to
          ...
          <li>
            ...
            <p>
              ...
              access of Amicus Lending’s systems and misuse of passwords or Site
              information is strictly prohibited. If you violate any of these
              Terms of Use or any other agreement between you and Amicus
              Lending, then Amicus Lending may restrict, suspend, or terminate
          ...
          <li>
            ...
            <p>
              ...
              device details, if available, to Amicus Lending and service
              providers for the duration of the business relationship, solely
              for identity verification and fraud avoidance. See Amicus
              Lending’s Privacy Policy at{" "}
              <a
                href="http://www.amicuslending.com/privacy"
                target="_blank"
                rel="noreferrer"
                className="link"
              >
                www.amicuslending.com/privacy
              </a>{" "}
          ...
          <li>
            ...
            <p>
              ...
              Amicus Lending’s Privacy Policy, which is incorporated by
              ...
              . You agree to Amicus Lending’s use of your data in accordance
          ...
          <li>
            ...
            <p>
              ...
              property of Amicus Lending with all rights reserved. Site Content
              may not be copied, reproduced, distributed, republished,
              displayed, posted, transmitted, or sold in any form or by any
              means without Amicus Lending’s prior written consent. You
              acknowledge that all Site Content is and shall remain the sole
              property of Amicus Lending. You may only access a Site and use the
          ...
          <li>
            ...
            <p>
              ...
              or right to use any trademark, whether owned by Amicus Lending or
          ...
          <li>
            ...
            <p>
              Because Amicus Lending operates its platform online and conducts
          ...
          <li>
            <p>
              <b>Electronic Communications:</b> You agree that Amicus Lending,
          ...
          <li>
            <p>
              ...
              e-mail to{" "}
              <a
                href="mailto:DocumentRequest@amicuslending.com"
                className="link"
              >
                DocumentRequest@amicuslending.com
              </a>{" "}
              ...
              submit your request by mail to Amicus Lending, 1920 Alcott Ave,
              Chico, CA 95928, Attention: Compliance Department. There is no fee
              for a paper copy.
            </p>
          </li>
          <li>
            <p>
              ...
              <a href="mailto:customercare@Amicuslending.com " className="link">
          ...
          <li>
            <p>
              ...
              logging into your account through Amicus Lending’s Account Portal,
              by calling us at{" "}
              <a href="tel:(877) 226-0660" className="link">
                (877) 226-0660
              </a>
              ...
              , or by writing to us at Amicus Lending, 1920 Alcott Ave, Chico,
              CA 95928, Attention: Compliance Department.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <b>Consent Generally:</b> You agree and consent to be contacted by
              us, our employees, agents, representatives, affiliates and/or
              anyone calling on our behalf (collectively, "Representatives") at
              any telephone number (including any mobile phone number) you
              provide to us and any physical or electronic address you provide
              to us, and you agree that we may use multiple means to contact you
              ...
              received; (2) calling us at{" "}
              <a href="tel:(877) 226-0660" className="link">
                (877) 226-0660
              </a>{" "}
              ; or (3) emailing customer service at{" "}
              <a
          ...
          <li>
            <p>
              ...
              at{" "}
              <a
                href="mailto:OptOut@amicuslending.com"
                className="link underline"
              >
                OptOut@amicuslending.com
              </a>{" "}
              or write to us at Amicus Lending, 1920 Alcott Ave, Chico, CA
              95928 Attention: Compliance Department. If you wish to change or
              stop receiving offers to specific telephone numbers, you may also
              call us at{" "}
              <a href="tel:(877) 226-0660" className="link">
                (877) 226-0660
              </a>{" "}
          ...
          <li>
            <p>
              ...
              , or via regular mail at Amicus Lending, 1920 Alcott Ave, Chico,
              CA 95928, Attn: Legal Department. In your notification, please:
            </p>
            <ol>
              <li>
                <p>
          ...
          <li>
            <p>
              ...
              information. Amicus Lending does not warrant or endorse and does
              ...
              Services, you acknowledge and agree that Amicus Lending is not
          ...
          <li>
            <p>
              ...
              Amicus Lending makes no representation that such Third-Party
              ...
              for compliance with all applicable laws. Amicus Lending reserves
              ...
              no event will Amicus Lending be liable for the removal of or
              disabling of access to any such Third-Party Services. Amicus
          ...
          <li>
            <p>
              AMICUS LENDING PROVIDES ITS SITE AND SERVICES "AS IS" AND "AS
              AVAILABLE" WITH ALL FAULTS AND WITHOUT ANY EXPRESS OR IMPLIED
              WARRANTIES INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF
              MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND
              NON-INFRINGEMENT. ADDITIONALLY, AMICUS LENDING MAKES NO CLAIM OR
              GUARANTEE AS TO THE ACCURACY OF ANY INFORMATION PROVIDED OR SITE
              CONTENT.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              IN NO EVENT WILL AMICUS LENDING OR ITS DIRECTORS, OFFICERS, OR
              ...
              FROM YOUR USE OF THE SITE OR SERVICES, EVEN IF AMICUS LENDING IS
          ...
          <li>
            <p>
              You agree to indemnify, defend, and hold harmless Amicus Lending
          ...
          <li>
            <p>
              <b>
                {" "}
                <i> Please read this Arbitration Agreement carefully.</i>
              </b>{" "}
              This Arbitration Agreement provides that all Disputes (defined
              below) between you and us must be resolved by binding arbitration.{" "}
              <b>
          ...
          <li>
            <p>
              ...
              number) and address. Your notice must be mailed to Amicus Lending,
              1920 Alcott Ave, Chico, CA 95928-0348 or emailed to{" "}
              <a href="mailto:customercare@Amicuslending.com " className="link">
                customercare@Amicuslending.com 
              </a>
              .
            ...
            <ol className="arbitration-agreemnet-notes">
              <li>
                <p>
                  ...
                  Amicus Lending, Amicus Lending&apos;s agents, servicers,
                  assigns , vendors and any third-party, Amicus Lending&apos;s
              ...
              <li>
                <p>
                  ...
                  <a
                    href="disputes@amicuslending.com"
                    className="link underline"
                  >
                    disputes@amicuslending.com
                  </a>
              ...
              <li>
                <p>
                  ...
                  Association ("AAA") through its website at{" "}
                  <a
                  ...
                  Eastern District of California - Sacramento or the courts of
                  the state of California sitting in Butte County to appoint the
                  arbitration service provider, as permitted under 9 U.S.C. 5.
                  (The AAA and any substitute arbitration service provider
                  selected or appointed as contemplated here collectively are
                  the "Arbitration Organization".) We will reimburse your filing
                  fees, reasonable attorneys' fees, and other costs of
              ...
              <li>
                <p>
                  ...
                  the sovereign status of Amicus Lending or expand the scope of
                  the limited waiver provided by Amicus Lending below in the
              ...
              <li>
                <p>
                  ...
                  Eastern District of California - Sacramento or if such federal
                  court fails to find jurisdiction, then in the courts of the
                  state of California sitting in Butte County, and appellate
                  courts therefrom. Amicus Lending grants a limited waiver of
                  its sovereign immunity which is limited to (i) arbitration of
                  a Dispute only in accordance with and subject to the terms of
                  this Arbitration Agreement, and (ii) enforcing a final award
                  issued in such arbitration in the United States District Court
                  for the Eastern District of California - Sacramento or if such
                  federal court fails to find jurisdiction then in the courts of
                  the state of California sitting in Butte County, and appellate
                  courts therefrom. This limited waiver is made by Amicus
                  Lending to you only, does not include any waiver (express or
                  implied) to any other person, and does not waive the sovereign
                  immunity of the Tribe or any of the Tribe's other entities.
                </p>
              </li>
              <li>
                <p>
          ...
          <li>
            <p>
              ...
              Mechoopda Consumer Finance Services Commission.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              ...
              reservation in Chico, California. You further acknowledge and
          ...
          <li>
            <p>
              <span className="underline">Waiver:</span> Amicus Lending&apos;s
          ...
          <li>
            <p>
              ...
              , email us at{" "}
              <a href="mailto:Compliance@amicuslending.com" className="link">
                Compliance@amicuslending.com
              </a>{" "}
              or write to Amicus Lending, 1920 Alcott Ave, Chico, CA 95928,
