...
const Section = () => {
  return (
    <Wrapper>
      <ul className="list">
        <li>
          <H3>WHAT DOES AMICUS LENDING DO WITH YOUR PERSONAL INFORMATION?</H3>
        </li>
        <li>
          <H4>Why?</H4>
          <p>
        ...
        <li>
          ...
          <p>
            ...
            the reasons Amicus Lending chooses to share; and whether you can
            limit this sharing.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              <p>
                Visit us online:
                <a href="www.amicuslending.com" className="link underline">
                  www.amicuslending.com
                </a>
                or email us at
                <a
          ...
          <Notification
            content={[
              <>
                ...
                are <b>no longer</b>
                our customer, we continue to share your information asdescribed
                in this notice.
              </>,
              <>
                {" "}
        ...
        <li>
          ...
          <p>
            ...
            or go to
            <a
              href="http://www.amicuslending.com"
              target="_blank"
            ...
            <Table className="table col-2">
              ...
              <div className="tbody col-2">
                <div className="tr">
                  ...
                  <div className="td">
                    This privacy notice is provided by Amicus Lending, LLC.
                  </div>
                </div>
              </div>
              ...
              <div className="tbody col-2">
                <div className="tr">
                  <div className="td">
                    <b>
                      How does Amicus Lending protect my personal information?
                    </b>
                  </div>
                  <div className="td">
                ...
                <div className="tr">
                  <div className="td">
                    <b>
                      How does Amicus Lending collect my personal information?
                    </b>
                  </div>
                  <div className="td">
                    <div>
                      ...
                      <ul>
                        <li>
                          <p>
                            ...
                            Mechoopda Indian Tribe of Chico Rancheria, a
              ...
              <div className="tbody col-1">
                <div className="tr">
                  <div className="td">
                    <p>
                      Tribal Notice: Amicus Lending is an arm of the Mechoopda
                      Indian Tribe of Chico Rancheria and is licensed and
                      regulated by the Tribe's Consumer Finance Services
                      Regulatory Authority pursuant to the Tribe's Consumer
                      Financial Services Regulatory Ordinance.
                    </p>
                  </div>
                </div>
              </div>
