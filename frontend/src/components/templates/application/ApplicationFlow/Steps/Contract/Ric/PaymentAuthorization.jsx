...
const PaymentAuthorization = ({
  ...
  const img = isPdf
    ? "https://lms-api.amicuslending.com/api/application/s3asset/amicus-logo-dark.svg"
    : logo;

  const paycheck = isPdf
    ? "https://lms-api.amicuslending.com/api/application/s3asset/paycheck.png"
    : paycheckImg;
  ...
  return (
    <Wrapper className="new-page">
      <div className="header">
        <div className="logo">
          <img src={logo} alt="AmicusLending" />
        </div>
      ...
      <p>
        ...
        <b>“Amicus,” “Lender,” “we,” “us” or “our,”</b>
        it means Amicus Lending. This Agreement also incorporates by reference
        the attached “Disclosure Statement for Recurring Auto Payments.”
      </p>
      ...
      <p>
        By signing below, I authorize Amicus Lending, (“Amicus”) to initiate
      ...
      <ul>
        <li>
          <p>
            Amicus will begin to deduct weekly payments from my bank account on
        ...
        <li>
          <p>
            This agreement is not assignable by me, however Amicus may, at any
        ...
        <li>
          <p>
            This authorization will remain in effect until terminated by Amicus
            ...
            , or verbally by calling 877-226-0660. Please include your name,
        ...
        <li>
          <p>
            In the event, I terminate this agreement, I understand that Amicus
      ...
      <div className="no-break">
        ...
        <p>
          By signing below, I acknowledge that I have read, understand and agree
          to be bound by all of the terms and conditions of this Agreement,
          including without limitation, the provisions of the Disclosure
          Statement for Recurring Automatic Payments below. When you sign this
          Agreement electronically, you agree that your electronic signature
          will have the same force and effect and will bind you to this
          Agreement in the same manner and to the same extent as a physical
          signature would do, in accordance with the ESIGN Act.
        </p>
        <p>
