  ...
  return (
    <Wrapper className="new-page">
      ...
      <p>
        ...
        knowledge and belief. I understand and agree that AMICUS LENDING, may
        obtain a consumer credit report in connection with this application and
        in connection with any updates, renewals or extensions of any credit as
