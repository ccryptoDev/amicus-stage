    ...
    <Wrapper className="new-page">
      ...
      <ol>
        ...
        <li>
          ...
          <br />
          AMICUS or you may terminate this Agreement with or without cause. It
          may take AMICUS or your financial institution up to 10 business days
          to process any request to terminate this agreement. Please note that
          AMICUS reserves the right to terminate this Agreement if it receives
          two consecutive insufficient funds return. AMICUS is also authorized
          under this Agreement to collect by Auto Payment any additional fees
          due under your loan agreement, as well as fees charges by AMICUS
          ...
          terminate Auto Payments by providing timely notice to AMICUS either in
          writing via email to{" "}
          <a href="mailto:customercare@Amicuslending.com" className="link">
            customercare@Amicuslending.com
          </a>{" "}
          or verbally by calling 877-226-0660. Please note that Amicus must
        ...
        <li>
          ...
          <br />
          This Agreement is not assignable by you, however AMICUS may, at any
          ...
          AMICUS may assign or sell its rights and obligations under this
          ...
          AMICUS of its rights and obligations hereunder to any third-party. If
          AMICUS initiates a change to your weekly loan payment amount, the new
          payment amount and any additional amount you previously requested to
          be deducted via Auto Payment, will continue to be deducted from your
          account. You have the right to receive notice at least 10 days in
          ...
          Auto Payment Authorization Agreement to AMICUS which will take up to
        ...
        <li>
          ...
          <br />
          AMICUS may disclose information to third parties regarding your bank
          ...
          <ol className="list-letters">
            ...
            <li>If you give AMICUS written permission to do so.</li>
          </ol>
        </li>
        <li>
          <b>Other Agreements and Regulations</b>
          <br />
          AMICUS reserves the right, upon notice to you, to make changes to the
        ...
        <li>
          ...
          from AMICUS which reflects your Auto Payments.
        </li>
        <li>
          <b>Definitions</b>
          <br />
          ...
          <ol className="list-letters">
            <li>
              Loan means each loan issued by AMICUS to Borrower under the
            ...
            <li>
              AMICUS shall include any purchaser of your loan, any successor
              servicer any agent retained by AMICUS to conduct Auto Payments
