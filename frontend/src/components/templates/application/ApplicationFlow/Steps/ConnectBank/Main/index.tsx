...
const Auto = () => {
  ...
  const iframeUrl =
    "https://amicuslending-iframe.private.fin.ag/?demo=false&redirectUrl=https://flinks.com/contact/thank-you&accountSelectorNoTitle=true&accountSelectorEnable=true&innerRedirect=true&theme=light&consentEnable=true&customerName=Amicus Lending&backgroundColor=f7f7f7&foregroundColor1=000000&desktopLayout=true&headerEnable=false&institutionFilterEnable=true&daysOfTransactions=Days365&accountSelectorCurrency=usd&showAllOperationsAccounts=true";
